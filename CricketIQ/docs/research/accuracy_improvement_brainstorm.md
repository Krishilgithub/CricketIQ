...
- Team recent form: last 5, last 10 weighted performance.
- Batting strength index: top-7 weighted strike-rate and boundary rate.
- Bowling strength index: wicket rate, economy, death-over control.
- Venue-adjusted strength: team performance at venue and similar venues.
- Head-to-head trend: recency-weighted matchup advantage.
- Toss probability impact by venue and chase/defend bias.
- Match context: tournament stage, pressure level, knockout indicator.
- Gender/competition segment effects (if mixed datasets are used together).
- Travel/rest gap and schedule congestion (if added from fixtures).
- Team composition balance: pace-spin split, all-rounder depth.
