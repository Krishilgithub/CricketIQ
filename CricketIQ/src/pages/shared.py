...
<style>
    ...
    .metric-card { background: #1e293b; border-radius: 12px; padding: 20px; margin: 8px 0; border: 1px solid #334155; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1); font-size: 1.15rem; }
    .section-header { font-size: 1.8rem; font-weight: 700; color: #38bdf8; margin-bottom: 16px; border-bottom: 2px solid #1e293b; padding-bottom: 8px; }
    .chat-msg-user { background: #0284c7; border-radius: 12px 12px 0 12px; padding: 12px 16px; margin: 4px 0; color: white; float: right; clear: both; max-width: 80%; font-size: 1.1rem; }
    .chat-msg-bot { background: #1e293b; border-radius: 12px 12px 12px 0; padding: 12px 16px; margin: 4px 0; border: 1px solid #334155; color: #f8fafc; float: left; clear: both; max-width: 80%; font-size: 1.1rem; }
    .stTextInput > div > div > input { background: #1e293b; color: white; border: 1px solid #334155; border-radius: 8px; font-size: 1.1rem; }
    ...
    .kpi-label { font-size: 0.95rem; color: #94a3b8; margin-top: 4px; }
