...
def get_exciting_matches():
    ...
    LIMIT 20
    """
    return con.execute(excitement_q).df()
...
def get_highest_scores():
    ...
    """
    return con.execute(top_bat_q).df()
...
def get_best_bowling():
    ...
    """
    return con.execute(top_bowl_q).df()
...
if persona == "🎯 Team Analyst":
    ...
    # Pull live features from DB (Cached)
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    phase_df = get_phase_data(venue_sel)
    ...
    toss_df = get_toss_recommendation(venue_sel)
